...
public class ProdutoController {
    ...
    public boolean adicionarProduto(int codigo, String nomeProduto, int qtddProduto, int dataEntrada, double valor){       
    ...
    public List<String[]> listarProdutos(){
        ...
        for (Produto produto : produtos){
            ...
            dadosProduto[4] = String.valueOf(produto.getValor());
            dadosProdutos.add(dadosProduto);
        }        
        return dadosProdutos;
    }
    
    public List<String[]> listarProdutosPorNome(String nomeProduto){
        List<String[]> dadosProdutos = new ArrayList<>();
        List<Produto> produtos = Produto.listarProdutosPorNome(nomeProduto);        
        for (Produto produto : produtos){
            String[] dadosProduto = new String[5];
            dadosProduto[0] = String.valueOf(produto.getCodigo());
            dadosProduto[1] = produto.getNomeProduto();
